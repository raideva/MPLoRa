...
p1 = pandas.read_csv("data_measurement_campaigns/Urban_Beirut/csv_urban_3m.csv")
p1['hr'] = [3] * len(p1)
p2 = pandas.read_csv("data_measurement_campaigns/Urban_Beirut/csv_urban_1_5m.csv")
p2['hr'] = [1.5] * len(p2)
p4 = pandas.read_csv("data_measurement_campaigns/Urban_Beirut/csv_urban_1m.csv")
p4['hr'] = [1.5] * len(p4)
p3 = pandas.read_csv("data_measurement_campaigns/Urban_Beirut/csv_urban_20cm.csv")
p3['hr'] = [.2] * len(p3)
